...
#include <tctdb.h>
  ...
  public:
    ...
    Initialize (const Handle<Object> target) {
      ...
      NODE_SET_PROTOTYPE_METHOD(Tmpl, "setindexSync", SetindexSync);
  ...
  public:
    ...
    Initialize (const Handle<Object> target) {
      ...
      NODE_SET_PROTOTYPE_METHOD(tmpl, "searchSync", SearchSync);
      NODE_SET_PROTOTYPE_METHOD(tmpl, "searchAsync", SearchAsync);
      NODE_SET_PROTOTYPE_METHOD(tmpl, "searchoutSync", SearchoutSync);
      NODE_SET_PROTOTYPE_METHOD(tmpl, "searchoutAsync", SearchoutAsync);
      NODE_SET_PROTOTYPE_METHOD(tmpl, "hint", Hint);
      NODE_SET_PROTOTYPE_METHOD(tmpl, "metasearchSync", MetasearchSync);
